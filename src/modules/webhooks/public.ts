/**
 * Public contract barrel of the `webhooks` module.
 *
 ...
 * module rule"). Everything else under `src/modules/webhooks/` is private to
 * this module.
 *
...
export const moduleDescriptor: ModuleDescriptor = { id: "webhooks" };
